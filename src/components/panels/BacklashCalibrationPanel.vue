<template>
    <panel
        ...
        :icon="mdiGamepad"
        :title="$t('Panels.BacklashCalibration.Headline')"
        :collapsible="true"
        card-class="backlash-calibration-panel">
        ...
        <template #buttons>
            ...
            <backlash-calibration-settings />
        </template>
        
        <!-- MOVE TO CONTROL -->
        
        <backlash-calibration-control />
...
import BacklashCalibrationControl from '@/components/panels/Calibration/BacklashCalibrationControl.vue'
...
@Component({
    components: {
        ...
        CircleControl,
        CrossControl,
        BacklashCalibrationControl,
        Panel,
        ToolSlider,
        ZoffsetControl,
    },
})
export default class BacklashCalibration extends Mixins(BaseMixin, ControlMixin) {
